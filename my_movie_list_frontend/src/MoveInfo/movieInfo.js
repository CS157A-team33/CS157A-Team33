...
class MovieInfo extends Component{
    ...
    getActors = async _=>{
        await fetch(`http://localhost:4040/getActors?contentname=${this.props.location.state.contentname}&releaseyear=${this.props.location.state.releaseyear}`)
        .then(res => res.json())
        .then(res => {
        ...
        {   
            if(this.state.actorString === '')
            {
                ...
                this.setState({actorString: this.state.actorString + ", "+ this.state.actors[i].actorname})
            }
                                    ...
                                    <div className="col">
                                        ...
                                        <MDBCard style={{background: "rgba(-1, -1, -1, 0.8)", float:"center",
                                            ...
                                            <MDBCardTitle style={{textAlign: "left", marginLeft: "1rem", fontFamily: 'Open Sans', color:"LightSeaGreen"}}>   
                                                ...
                                                {/* </MDBCardBody>
                                                <MDBCardBody style={{color: "White", fontSize: "15px"}}> */}
                                                <h6 style={{color: "SkyBlue", fontSize: "20px",marginTop: "1rem"}}>Episodes </h6>
                                                    {no_of_episodes}
                                                {/* </MDBCardBody>
                                                <MDBCardBody style={{color: "White", fontSize: "15px"}}> */}
                                                <h6 style={{color: "SkyBlue", fontSize: "20px",marginTop: "1rem"}}>Director </h6>
